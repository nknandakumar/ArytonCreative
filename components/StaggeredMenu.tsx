  ...
  return (
    ...
    >
      ...
      >
        ...
        <header
          className="staggered-menu-header absolute top-0 left-0 w-full flex items-center justify-between p-[2em] bg-transparent z-20 transition-all duration-300"
          ...
          >
            ...
            >
              <span ref={textInnerRef} className="sm-toggle-textInner flex flex-col leading-none">
                {textLines.map((l, i) => (
                  <span className="sm-toggle-line block h-[1em] leading-none pt-[1px]" key={i}>
                    {l}
                  </span>
                ))}
              </span>
        ...
        >
          <div className="sm-panel-inner flex-1 flex flex-col gap-8">
            ...
            >
              {items && items.length ? (
                ...
                <li className="sm-panel-itemWrap relative overflow-hidden leading-none" aria-hidden="true">
                  <span className="sm-panel-item relative text-brand-white font-heading text-[4rem] cursor-pointer leading-[0.85] uppercase inline-block pr-[1.4em]">
                    <span className="sm-panel-itemLabel inline-block [transform-origin:50%_100%] will-change-transform">
                      No items
                    </span>
                  </span>
            ...
            {displaySocials && socialItems && socialItems.length > 0 && (
              <div className="sm-socials mt-auto pt-12 flex flex-col gap-4" aria-label="Social links">
                <ul
      ...
      <style>{`
.sm-scope {
  /* To ensure scrolling works on the rest of the page when closed, we set pointer-events to none unless open */
}
