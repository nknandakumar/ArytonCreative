...
import { TextReveal, RevealContainer, RevealItem } from "./animations/Reveal";
  ...
  return (
    <>
      <div className="w-full flex-1 md:min-h-[85vh] flex flex-col justify-start">
        ...
        <RevealContainer className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-8 lg:gap-12 w-full h-full">
          
          {/* Main Image (Left on Desktop, Top on Mobile) */}
          <RevealItem delay={0.1} className="w-full flex-1 md:w-auto">
            <div 
              className="relative w-full aspect-[4/5] md:aspect-auto md:h-[85vh] overflow-hidden order-1 md:order-1 cursor-pointer touch-pan-y"
          ...
          <RevealItem delay={0.2} className="w-full md:hidden order-2">
